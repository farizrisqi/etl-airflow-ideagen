...
def run(playwright: Playwright) -> None:
    ...
    search_box.fill("ressa")
    search_box.press("Enter")
    
    page.wait_for_timeout(5000)

    print("🖱️ Memilih dashboard 'DASHBOARD SRM")
    page.get_by_text("BUSINESS INTELLEGENCE PUNYA").click()
    
    print("⏳ Menunggu Website Stabil ")
    page.wait_for_timeout(15000)
    page.get_by_role("button", name="Apply").click()
    print("⏳ Tombol Apply diklik, menunggu data load...")
    page.get_by_role("button", name="Export").click(timeout=600000)
    ...
    try:
        ...
        final_filename = "bi_srm_bronze_layer.xls"
