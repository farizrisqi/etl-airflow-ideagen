...
## 📌 Project Description
This project is an end-to-end solution for data extraction, processing, and automation. Focusing heavily on **Big Data, Data Engineering, and Machine Learning** practices, this pipeline is designed to automatically retrieve data from internal systems, process it through a Dual-Stream ETL pipeline, and distribute it for both administrative automation (RPA) and text-based Artificial Intelligence processing (NLP).
